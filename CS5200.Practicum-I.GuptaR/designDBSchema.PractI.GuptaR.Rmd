...
db <- read.csv("restaurant-visits.csv")
# ***************CHANGE TO ONLINE CV *********!!!!!!!!!!!
...
# here
maxVisit <- max(dbTest$VisitDate)
minVisit <- min(dbTest$VisitDate)

# This what those sentinels look like in the two cols where I know they already exist
minStartDate <- min(dbTest$StartDateHired, na.rm = T)
maxEndDate <- max(dbTest$EndDateHired, na.rm = T)
```
